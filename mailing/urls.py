...
from mailing.services import toggle_activity
...
urlpatterns = [
    ...
    path("<int:pk>/mailingtext_update", MailingTextUpdateView.as_view(), name="mailingtext_update"),
    path("<int:pk>/mailingtext_delete", MailingTextDeleteView.as_view(), name="mailingtext_delete"),
